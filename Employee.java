...
public class Employee extends JPanel {
	...
	public void design() {
		...
		JLabel title = new JLabel("ìƒˆë¡œìš´ ì§�ì›� ì •ë³´ ì¶”ê°€");
		...
		JButton addButton = new JButton("ì •ë³´ ì¶”ê°€í•˜ê¸°");
		...
		addButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (fname.isEmpty()) {
					JOptionPane.showMessageDialog(null, "First Name ìž…ë ¥ì�„ í™•ì�¸í•´ì£¼ì„¸ìš”.");
					return;
				} else if (minit.length() > 1) {
					JOptionPane.showMessageDialog(null, "Middle Init.ì�€ í•œ ê¸€ìž�ì—¬ì•¼ í•©ë‹ˆë‹¤.");
					return;
				} else if (lname.isEmpty()) {
					JOptionPane.showMessageDialog(null, "Last Name ìž…ë ¥ì�„ í™•ì�¸í•´ì£¼ì„¸ìš”.");
					return;
				} else if (ssn.length() != 9) {
					JOptionPane.showMessageDialog(null, "Ssn ìž…ë ¥ì�„ í™•ì�¸í•´ì£¼ì„¸ìš”.");
					return;
				} else if (bdate.split("-").length != 3 && !bdate.isEmpty()) {
					JOptionPane.showMessageDialog(null, "Birthdate ìž…ë ¥ì�„ í™•ì�¸í•´ì£¼ì„¸ìš”.");
					return;
				} else if (superSsn.length() != 9 && !superSsn.isEmpty()) {
					JOptionPane.showMessageDialog(null, "Super_Ssn ìž…ë ¥ì�„ í™•ì�¸í•´ì£¼ì„¸ìš”.");
					return;
				}
				...
				if (salaryString.isEmpty()) {
					...
					try {
						...
						JOptionPane.showMessageDialog(null, "Salary ìž…ë ¥ì�„ í™•ì�¸í•´ì£¼ì„¸ìš”.");
						return;
					}
				}
